...
/* JavaScript content from js/views/addscheduler.js in folder common */
/**
 * 
 */
...
//		   navigation.loadAsync(function(){ADF.view.addscheduler.elapsedTime();window.busy.hide();});
		  ...
		  navigation.loadAsync(function(){
			   console.log(" navigation.loadAsync displaydetail addscheduler..................");			   
			   ADF.view.addscheduler.elapsedTime();
			   window.busy.hide();
//			   var myScroll = new iScroll('addschedulerScroll', {
//		              hScrollbar : false,
//		              vScrollbar : false
//			   });
			   
			   console.log("  navigation.loadAsync(function() after................");
		   	});	   
