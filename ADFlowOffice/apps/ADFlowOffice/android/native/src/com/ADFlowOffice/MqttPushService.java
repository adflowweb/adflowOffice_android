...
public class MqttPushService extends Service implements MqttCallback {
	...
	private static final String SERVERURL = "tcp://adflow.net:1883"; // raspberryPI
	...
	private static final int ADFLOW_STYLE = 3;
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (intent.getAction() != null
			...
			Toast toast = Toast.makeText(this, "userID:" + userID + tokenID,
					Toast.LENGTH_SHORT);
			toast.show();
	...
	private void showNotification(MqttMessage message) throws Exception {
		Log.d(DEBUGTAG, new String(message.getPayload()));
		...
		Log.d(DEBUGTAG, noti.toString());
		NotificationManager manager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
		Notification notification = null;

		Intent resultIntent = new Intent(this,
				com.ADFlowOffice.ADFlowOffice.class);
		...
		case ADFLOW_STYLE:
			...
			notification = new Notification.BigTextStyle(
					new Notification.Builder(getApplicationContext())
							...
							.setTicker(noti.getString("ticker"))
							.addAction(R.drawable.ic_action_search, DETAILVIEW,
									intent).setLargeIcon(bm).setLargeIcon(bm))
					.bigText(noti.getString("contentText")).build();
